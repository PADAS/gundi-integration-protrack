...
@pytest.mark.asyncio
async def test_action_pull_observations_triggers_playback_action(mocker, integration_v2):
...
@pytest.mark.asyncio
async def test_action_pull_observations_no_devices(mocker, integration_v2):
    mocker.patch("app.actions.client.get_token", return_value="fake_token")
    mocker.patch("app.actions.client.get_devices", return_value=[])
    integration = integration_v2
...
@pytest.mark.asyncio
async def test_action_pull_observations_auth_failure(mocker, integration_v2):
...
@pytest.mark.asyncio
async def test_action_playback_no_observations(mocker, integration_v2):
    mocker.patch("app.actions.client.get_playback_observations", return_value=[])
...
@pytest.mark.asyncio
async def test_action_playback_http_error(mocker, integration_v2):
